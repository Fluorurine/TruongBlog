...
function BannerGroup(props) {
  return (
    ...
    <div
      id="bannerGroup"
      className="flex flex-col justify-between flex-1 mr-2 "
    >
      {/* 动图 */}
      <Banner {...props} />
      {/* 导航分类 */}
    ...
    >
      ...
      >
        <div className="ml-12 -translate-x-32 group-hover:translate-x-0 duration-300 transition-all ease-in">
          <div className="text-7xl text-white font-extrabold">Xem thêm bài post</div>
...
function GroupMenu() {
  return (
    <div className="h-[165px] select-none xl:h-20 flex flex-col justify-between xl:space-y-0 xl:flex-row w-full lg:w-48 xl:w-full xl:flex-nowrap xl:space-x-3">
      <Link
...
function TopGroup(props) {
  ...
  return (
    <div
      ...
      className="sm:flex-1 hidden sm:relative sm:w-full"
    >
      {/* 置顶推荐文章 */}
      <div
        id="top-group"
