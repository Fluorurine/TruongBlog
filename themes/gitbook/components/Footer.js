...
const Footer = ({ siteInfo }) => {
  ...
  return (
        ...
        >
            ...
            <div className='text-xs font-serif'>Powered By <a href='https://vmtruong.vercel.app/' className='underline text-gray-500 dark:text-gray-300'>Truongvm {siteConfig('VERSION')}</a></div>
